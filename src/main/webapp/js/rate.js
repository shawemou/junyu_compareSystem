...
function queryStatCallBack(data, textStatus) {
	...
	for ( var i in myobj["data"]) {
		...
		var tdhtml = '<tr>' + 
		'<td style="text-align:center;vertical-align:middle;">' + typeName(item["typeId"]) + '</td>'
		+ '<td  style="text-align:center;vertical-align:middle;">' + item["totalCount"] + '</td>' 
		+ '<td  style="text-align:center;vertical-align:middle;">' + (item["rightCount"]==null?"0":item["rightCount"])+ '</td>'
		+ '<td  style="text-align:center;vertical-align:middle;">' + (item["rightCount"]/item["totalCount"])+ '</td>'
		+ '</tr>';
